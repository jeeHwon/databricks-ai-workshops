...
|-------|-------------------|----------|-------|
| **Simple (L100)** | AI agent using managed Databricks services — Genie, Vector Search, Playground. No custom code. | ~3 hours | [Lab Guide](./simple/LAB_GUIDE.md) |
| **Medium (L200)** | Custom agent with OpenAI Agents SDK, MCP tools, Lakebase memory, and chat UI deployed as a Databricks App. | ~4 hours | [Workspace Guide](./medium/lab_instructions/SETUP_GUIDE_WORKSPACE_ONLY.md) |
| **Advanced (L300)** | Production-grade LangGraph agent with MCP, persistent memory, streaming UI, and evaluation suite. | 2 days | [Local Guide](./advanced/WORKSHOP_INSTRUCTIONS.md) / [Workspace Guide](./advanced/WORKSHOP_INSTRUCTIONS_WORKSPACE.md) |
